...
export const UserDashboard: React.FC = () => {
  ...
  return (
    <div className="p-6 lg:p-10 max-w-7xl mx-auto space-y-8 animate-fadeIn select-none font-sans transition-colors duration-200">
      ...
      {/* Embedded AERA Spatial AI Assistant Chat Feature */}
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Sparkles className="w-4 h-4 text-[#D4AF37] dark:text-[#8C5232]" />
            <h2 className="text-base font-extrabold text-neutral-900 dark:text-white">AERA Spatial AI Co-Pilot</h2>
          </div>
          <span className="text-xs text-neutral-400 dark:text-neutral-500 font-mono">Live Conversational Intelligence</span>
        </div>

        <div className="h-[380px] bg-white dark:bg-[#161B22] rounded-3xl border border-[#E8E6DF] dark:border-[#21262D] overflow-hidden shadow-xs">
          <AIAssistantPanel />
        </div>
      </div>
